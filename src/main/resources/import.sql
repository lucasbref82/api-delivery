...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id) values (2, 'Thai Delivery', 9.50, 1, current_timestamp, current_timestamp, 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id) values (3, 'Tuk Tuk Comida Indiana', 15, 2, current_timestamp, current_timestamp, 2);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id) values (4, 'Java Steakhouse', 12, 3, current_timestamp, current_timestamp, 3);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id) values (5, 'Lanchonete do Tio Sam', 11, 4, current_timestamp, current_timestamp, 4);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id) values (6, 'Bar da Maria', 6, 4, current_timestamp, current_timestamp, 5);
